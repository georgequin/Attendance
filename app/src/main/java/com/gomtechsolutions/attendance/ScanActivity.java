...
public class ScanActivity extends AppCompatActivity {
    private TextView tvStatus, courseDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String extra = getIntent().getStringExtra("c_details");
        String extra1 = getIntent().getStringExtra("c_details1");
        courseDetails.setText(extra + " " + extra1);
    }
